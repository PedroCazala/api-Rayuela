...
SubProductsRoutes.delete("/:idSubProduct", auth_1.passport.authenticate("jwt-admin", { session: false }), sub_products_controller_1.SubProductsController.deleteSubProduct);
